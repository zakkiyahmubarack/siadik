      ...
      <nav class="navbar navbar-static-top" role="navigation" style="vertical-align:center;">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            <li><a href="#">
                <h4><?php echo $iden['title_identitas']; ?></h4>
              </a></li>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="<?php echo base_url(); ?>/no-telp-kategori"><i class="glyphicon glyphicon-phone"></i> <span>Kategori Nomor HP</span></a></li>
      ...
      if (empty($_SESSION['username']) and empty($_SESSION['password'])) {
        ...
        switch (url_segment(1)) {
          ...
          case 'password':
            ...
            break;
          case 'mesin':
            include "views/mesin.php";
            break;
          case 'user':
            include "views/user.php";
            break;
          case 'sidik-jari':
            include "views/sidik-jari.php";
            break;
          case 'foto-user':
            include "views/foto-user.php";
            break;
          case 'no-telp':
            include "views/no-telp.php";
            break;
          case 'no-telp-kategori':
            include "views/no-telp-kategori.php";
            break;
          case 'group':
            include "views/group.php";
            break;
          case 'pengelolaan-group':
            include "views/pengelolaan-group.php";
            break;
          case 'sys-time':
            include "views/sys-time.php";
            break;
          case 'clear-log':
            include "views/clear-log.php";
            break;
          case 'p-keluar':
            include "views/p-keluar.php";
            break;
          case 'p-masuk':
            include "views/p-masuk.php";
            break;
          case 'p-terkirim':
            include "views/p-terkirim.php";
            break;
          case 'p-tulis':
            include "views/p-tulis.php";
            break;
          case 'log-absen':
            include "views/log-absen.php";
            break;
          case 'report-absen':
            include "views/report-absen.php";
            break;
          case 'report-absen-status':
            include "views/report-absen-status.php";
            break;
          case 'report-absen-waktu':
            include "views/report-absen-waktu.php";
            break;
          case 'report-terlambat':
            include "views/report-terlambat.php";
            break;
          case 'grafik-sms':
            include "views/grafik-sms.php";
            break;
          case 'help':
            include "views/help.php";
            break;
          case 'bell':
            include "views/bell.php";
            break;
          case 'jadwal':
            include "views/jadwal.php";
            break;
          case 'report-individu':
            include "views/report-individu.php";
            break;
          case 'qr_whatsapp':
            include "views/qr_whatsapp.php";
            break;
        }
      }
      ?>
