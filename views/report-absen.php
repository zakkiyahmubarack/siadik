<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Report Absen Berdasarkan Jumlah Jam Kerja
			...
			<?php
				...
				switch(url_segment(2)){
					...
					case "cari" :
						...
						echo"<h4>DAFTAR HADIR ".strtoupper($group['nama_group'])." BULAN ".strtoupper(get_bulan($_POST['bulan']))." TAHUN $_POST[tahun]</h4>";
						...
						if($jum_t >= 1){
							...
							echo"<table width='100%' cellspacing='0' cellpadding='2' border='1'>
							  ...
							  $query=mysqli_query($koneksi,"select * from tbl_member a 
								...
								echo"<td align='center'>".array_sum($isi_data[$nom])."</td>";
							...
							echo"</div>";
							echo "<p><br>
								<a href='".base_url()."/views/excel_report.php?bulan=$_POST[bulan]&tahun=$_POST[tahun]&group=$_POST[group]' class='btn btn-success'><span class='glyphicon glyphicon-save-file'></span> Export Excel</a>
