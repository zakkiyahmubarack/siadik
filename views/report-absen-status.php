<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Report Absen Berdasarkan Log Masuk dan Pulang
				...
				switch(url_segment(2)){
					...
					case "cari" :
						...
						if($jum_t >= 1){
							...
							echo"</div>";
							echo "<p><br>
								<a href='".base_url()."/views/excel_report-status.php?bulan=$_POST[bulan]&tahun=$_POST[tahun]&group=$_POST[group]' class='btn btn-success'><span class='glyphicon glyphicon-save-file'></span> Export Excel</a>
